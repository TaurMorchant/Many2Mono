...
2. Если ветка отсутствует в репозитории — пропускает с предупреждением
...
**Важно:** Если какая-то ветка отсутствует в одном из репозиториев, она будет пропущена с предупреждением, но процесс продолжится для остальных.
